    ...
    <div className={styles.container}>
      ...
      <details className={styles.details}>
        ...
        <div className={styles.detailsContent}>
          ...
          <p>
            Es una plataforma web educativa y de inversión que te permite
            conocer, comparar y acceder a instrumentos financieros tradicionales
            y no tradicionales.
          </p>
          <h3>¿Es necesario registrarse para usar la plataforma?</h3>
          <p>
            No. Podés navegar como usuario invitado y acceder a información
            básica sobre rendimientos y riesgos de distintos instrumentos. Sin
            embargo, al registrarte podrás acceder a funcionalidades adicionales
            como el test de inversor, el carrito de inversiones y los cursos
            especializados.
          </p>
      ...
      <details className={styles.details}>
        ...
        <div className={styles.detailsContent}>
          ...
          <p>
            Toda la información se maneja bajo estrictos estándares de
            seguridad. Los datos sensibles y los medios de pago se almacenan de
            forma encriptada.
          </p>
        </div>
      </details>
      ...
      <details className={styles.details}>
        ...
        <div className={styles.detailsContent}>
          ...
          <p>
            Podés visualizar instrumentos financieros, sus rendimientos y
            riesgos, y realizar el test de perfil inversor.
          </p>
          <h3>¿Qué incluye el nivel Premium?</h3>
          <p>
            Acceso a análisis de riesgo detallados, estrategias de inversión
            personalizadas, y contenido educativo exclusivo como webinars y
            guías.
          </p>
          <h3>¿Qué ofrece el nivel de Asesoramiento Personalizado?</h3>
          <p>
            Incluye acompañamiento individual, estrategias de inversión
            adaptadas a tus objetivos y un modelo de pago por resultados.
          </p>
        </div>
      </details>
      ...
      <details className={styles.details}>
        ...
        <div className={styles.detailsContent}>
          ...
          <p>
            No. La plataforma te brinda información y herramientas para que
            tomes decisiones informadas, pero no ejecuta inversiones
            directamente.
          </p>
          <h3>¿Puedo invertir desde la plataforma?</h3>
          <p>
            Podrás acceder a enlaces a brokers o plataformas externas donde
            concretar tus inversiones. Liberty Finance no retiene fondos ni
            actúa como intermediario financiero.
          </p>
          <h3>¿La información sobre rendimientos está actualizada?</h3>
          <p>
            Sí. Los datos se actualizan periódicamente mediante APIs financieras
            y fuentes verificadas, con un mantenimiento regular cada 7, 15 o 30
            días.
          </p>
        </div>
      </details>
      ...
      <details className={styles.details}>
        ...
        <div className={styles.detailsContent}>
          ...
          <p>
            No. Es solo una guía. La decisión final de inversión siempre es
            tuya.
          </p>
        </div>
      </details>
